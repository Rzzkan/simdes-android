...
public class DetailBeritaActivity extends AppCompatActivity {
    ...
    public void _actionView(){
        txtJudul.setText("" + DataHelper.data_berita.judul);
        txtTanggal.setText("Oleh: " + DataHelper.data_berita.user.name + " | " + GeneralHelper.formatDate(DataHelper.data_berita.created_at));
        displayDetail(DataHelper.data_berita.deskripsi);
        if(!DataHelper.data_berita.gambar.equals("") && DataHelper.data_berita.gambar != null){
            Glide.with(this)
                    .load(Config.PATH_IMG + DataHelper.data_berita.gambar)
