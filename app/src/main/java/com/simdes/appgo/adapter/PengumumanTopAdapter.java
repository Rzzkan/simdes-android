...
public class PengumumanTopAdapter extends RecyclerView.Adapter<PengumumanTopAdapter.ViewHolder>{

    public ArrayList<PengumumanModel> rvData;
    public Context context;
    public int poss;

    public PengumumanTopAdapter(ArrayList<PengumumanModel> inputData, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // membuat view baru
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.pengumuman_top_adapter, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.btnItem.setOnClickListener(view -> {
            DataHelper.data_pengumuman = rvData.get(position);
            Intent u = new Intent(context.getApplicationContext(), DetailPengumumanActivity.class);
