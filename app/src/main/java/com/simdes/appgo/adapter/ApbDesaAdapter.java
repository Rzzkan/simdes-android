...
import com.simdes.appgo.ApbDesaActivity;
...
public class ApbDesaAdapter extends RecyclerView.Adapter<ApbDesaAdapter.ViewHolder>{

    public ArrayList<ApbDesaModel> rvData;
    public Context context;
    public int poss;

    public ApbDesaAdapter(ArrayList<ApbDesaModel> inputData, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // membuat view baru
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.apb_desa_adapter, parent, false);
