...
public class BeritaAdapter extends RecyclerView.Adapter<BeritaAdapter.ViewHolder>{
    ...
    public BeritaAdapter(ArrayList<BeritaModel> inputData, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // membuat view baru
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.berita_adapter, parent, false);
